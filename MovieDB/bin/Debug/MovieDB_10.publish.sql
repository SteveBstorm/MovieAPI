...
GO
:setvar DatabaseName "fq"
:setvar DefaultFilePrefix "fq"
...
GO
PRINT N'Création de Table [dbo].[Actor]...';
...
GO
PRINT N'Création de Table [dbo].[Comment]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_Person_Actor]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_Person_Movie]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_COMMENT_MOVIE]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_COMMENT_USER]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_Realistor]...';
...
GO
PRINT N'Création de Déclencheur [dbo].[UserSoftDelete]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[DeletePerson]...';
